...
type AccountCreateReq struct {
	...
	Password      string  `p:"password" v:"required|min-length:8#Password can not be empty|Password must be at least 8 characters" dc:"Password"`
...
type AccountPasswordReq struct {
	...
	NewPassword   string `p:"newPassword" v:"required|min-length:8#New password can not be empty|Password must be at least 8 characters" dc:"New password"`
}
